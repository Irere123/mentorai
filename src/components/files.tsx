...
export const Files = ({
  ...
  return (
    <motion.div
      className="fixed inset-0 bg-zinc-900/50 z-40 flex flex-row justify-center items-center"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      <motion.div
        className={cx(
          ...
          { "w-full h-[80vh] bottom-0 right-0 rounded-t-2xl": !isDesktop },
          { "w-[600px] h-[80vh] rounded-2xl": isDesktop }
        )}
        initial={{
          y: "100%",
